/*NOTA: Maestra, esta plantilla venia correctamente
programada, yo solo cambie los sprites/imagenes y textos*/
...
function draw() {
  ...
  textAlign("center");
  textSize(40);
  text("TIRO ALFA-ULTRA-HIPER-MEGA-SUPER EPICO DE ARCO", width / 2, 550);
